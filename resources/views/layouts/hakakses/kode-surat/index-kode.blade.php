...
@section('page-title', 'Kode Klasifikasi')
        ...
        <div class="section-body">
            <div class="card">
                <div class="col-md-6 py-2 d-flex align-items-center">
                    <a href="{{ route('kode-surat.create') }}" class="btn btn-success mr-3 d-flex align-items-center"
                        role="button">
                        <i class="fa fa-plus-circle mr-1"></i> Tambah Kode
                    </a>
